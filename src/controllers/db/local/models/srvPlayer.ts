...
export function srvPlayerModel(dbconn: mongoose.Connection): mongoose.Document | {} {
    return dbconn.model("srvPlayer", new mongoose.Schema({
            ...
            bannedReason: {
                type: String,
                default: "Your access to DDCS has been restricted, Please Contact An Admin"
            },
            gciAllowed: {
                type: Boolean,
                default: false
            ...
            patreonLvl: {
                type: String,
                required: true,
                default: "nonSubscriber"
            },
            premiumSideSwitchTimer: {
                type: Date
            }
        },
        {
