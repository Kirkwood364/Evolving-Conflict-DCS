...
export let engineGlobals = {
    ...
    strategicPointsOwnershipMarked: false
};

export let engineCache = {
    unitDictionary: [],
    weaponsDictionary: [],
    airfieldDictionary: [],
    bases: [],
    ...
    campaign: {} as typings.ICampaignConfig,
    i18n: {} as any
};
...
export const AIRBASE_CATEGORY: string[] = [
    "AIRDROME",
    "HELIPAD",
    "SHIP"
];
...
// export const maxLifePoints: number = getEngineCache().campaign.startMaxPoints;
...
export function setCampaign(curCampaign: typings.ICampaignConfig): void {
    engineCache.campaign = curCampaign;
}
...
export function setAirfieldDictionaries(curAirfields: any): void {
    engineCache.airfieldDictionary = curAirfields;
}

export function setBases(curCampaignAirfields: any): void {
    engineCache.bases = curCampaignAirfields;
}
